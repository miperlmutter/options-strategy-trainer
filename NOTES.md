...
- Each player keeps **two bests per game**: their **most-correct run** (tie-break: higher score) and their **top-100%-accuracy run**, deduped to one row when they're the same run.
